...
class ContentService {
  ...
  async update(courseId: string, id: string, updateContentRequest: UpdateContentRequest): Promise<void> {
    await apiService.put(`/api/courses/${courseId}/contents/${id}`, updateContentRequest);
  }
